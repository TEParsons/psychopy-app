<script>
    ...
    export let name;
    /** @prop @type {{valueParam: import("$lib/experiment.svelte.js").Param|null, typeParam: import("$lib/experiment.svelte.js").Param|null, expectedParam: import("$lib/experiment.svelte.js").Param|null}}*/
    export let params;
</script>
