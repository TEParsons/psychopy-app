...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/builder" | "/builder/components" | "/builder/flow" | "/builder/flow/controls" | "/builder/ribbon" | "/builder/routines" | "/coder" | "/coder/notebook" | "/coder/ribbon" | "/runner";
		RouteParams(): {
